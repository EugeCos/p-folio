...
<body>
    ...
    <section class="section-about picture-background js--section-features" id="about">
        ...
        <div class="row js--wp-1">
            ...
            <div class="col span-1-of-2 myBio">
                ...
                <p style="color: rgb(48, 48, 48)">Graduated from BrainStation Toronto full-time web development 10-week program in December 2017. Prior to engaging in web development I spent 5 years working in interational logistics, coordinationg complex import and export projects. I opted for a career switch to webdev because I consider this path to be a fresh, fast-paced, challenging and rewarding working environment. I also love to try out the latest technologies. Excellent knowledge of React, Node.js, Express and MongoDB.</p><br>
    ...
    <section class="section-features project-list picture-background js--section-features clearfix" id="works">
        ...
        <div class="row js--wp-2">
            <div class="col span-1-of-3">
                <a href="#fairmont" style="text-decoration:none">
                    <figure class="project-box">
                        <img src="./resources/img/projects/fairmont-cover.JPG" alt="fairmont" />
                        <p class="text">Fairmont Property Management</p>
                    </figure>
                </a>
            </div>
            <div class="col span-1-of-3">
                <a href="#crypto" style="text-decoration:none">
                    <figure class="project-box">
                        <img src="./resources/img/projects/crypto-cover.JPG" alt="crypto" />
                        <p class="text">Crypto Currency Tracker</p>
                    </figure>
                </a>
            </div>
            <div class="col span-1-of-3">
    ...
    <section class="section-features picture-background js--section-features" id="fairmont">
        <div class="row">
            <h2>Fairmont Property Management</h2>
        </div>
        <div class="row js--wp-1">
            <div class="col span-1-of-2">
                <img src="./resources/img/projects/fairmont-cover.JPG" class="appImage" alt="fairmont">
            </div>
            <div class="col span-1-of-2 appDescription">
                <p><b>Fairmont Property Management</b> is a presentational platform that allows visitors to explore company services and properties. Built in React using mobile-first approach based on designer's prototype; fully responsive and compatible with all browsers. Sanity.io was used to build a custom CMS for the client, this feature allows them to easily update pictures and content.</p>
                <br>
                <p><b>Fairmont Property Management</b> is a single page application made with React Router.</p>
                <div>
                    <i class="fab fa-react appFonts"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                    <i class="fab fa-node appFonts"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                    <i class="fab fa-js-square appFonts"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                    <i class="fab fa-less appFonts"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
                <div class="visit-project">
                    <a href="https://fairmontmanagement.com/" target="_blank" class="btn btn-project">Visit Project</a>
                </div>
            </div>
        </div>
    </section>

    <section class="section-features picture-background js--section-features" id="crypto">
        <div class="row">
            <h2>Crypto Currency Tracker</h2>
        </div>
        <div class="row js--wp-1">
            <div class="col span-1-of-2">
                <img src="./resources/img/projects/crypto-cover.JPG" class="appImage">
            </div>
            <div class="col span-1-of-2 appDescription">
            <h3 class="space-between-text">&nbsp;</h3>
                <p>A serverless web-app that allows users to look up cryptocurrencies and perform basic virtual trade manipulations (buy and sell coins).</p><br>
                <p>Crypto currencies data from CryptoCompare API.</p>
                <div>
                    <i class="fab fa-js-square appFonts"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                    <i class="fab fa-react appFonts"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                    <i class="fab fa-css3-alt appFonts"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                    <i class="fab fa-less appFonts"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                    <i class="fab fa-gulp appFonts"></i>&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
                <div class="visit-project">
                    <a href="http://euge-cryptotracker.herokuapp.com/" target="_blank" class="btn btn-project">Visit Project</a>
                </div>
            </div>
        </div>
    </section>
                ...
                <ul class="social-icons-contacts">
                    <a href="mailto:eugene.costov@ymail.com" class="social-email">
                        <li>
                            ...
                            <span>&nbsp;&nbsp;/&nbsp;eugene.costov@gmail.com</span>
                    </a>
                    </li>
                    <a href="https://ca.linkedin.com/in/eugenecostov" target="_blank" class="social-linked">
                        <li>
